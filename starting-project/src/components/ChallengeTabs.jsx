...
function Tab({ isSelected, onSelect, badgeCaption, children }) {
  return (
    <li>
      ...
      {isSelected && <motion.div layoutId="tab-indicator" className="active-tab-indicator" />}{/*O layoutId é o id que será usado para fazer a animação de layout entre os elementos*/}
    </li>
  );
}
